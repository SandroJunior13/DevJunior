...
<div style="display: inline_block">
  <img align="center" alt="C# src="img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=csharp&logoColor=white" />
  <img align="center" alt=".NET" src="img.shields.io/badge/.NET-5C2D91?style=for-the-badge&logo=.net&logoColor=white" />
</div><br/>
 Para consultar e gerenciar o estoque de produtos por referência.
...
O projeto `TesteDeveloperTests` tem 11 testes (NUnit) cobrindo os três métodos originais. Para rodar:

```bash
cd TesteDeveloperTests
dotnet test
```
